...
def main() -> None:
    ...
    # You can change the following code in order to suit your specific case:
    
    # Create as many personal rules as needed:
    personal_eid_rules = [(partial(is_date_less_desired_weekday, 4), 65)]
    
    # Create people objects and add unavailablities
    ...
    # Create a list of all the people you've created
    people = [p1, p2, p3, p4]

    # End of user input. Don't touch the following code.
